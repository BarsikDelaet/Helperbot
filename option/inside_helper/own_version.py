...
class OwnVersion(Service):
    """Создание и обработка всех кнопок раздела."""

    def menu_own_version(self, msg):
        """Меню с кнопками."""
        self.bot.send_message(msg.chat.id, answer.HELLO_THEIR_QUESTION,
                              reply_markup=types.ReplyKeyboardRemove())
        self.bot.register_next_step_handler(msg, self.their_question)

    def their_question(self, msg):
        """Отправка их вопроса."""
        self.bot.send_message(msg.chat.id, answer.THEIR_QUESTION,
